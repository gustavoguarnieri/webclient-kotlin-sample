package com.example.webclientimageskotlinsample.config
...
class SwaggerConfig( @Value("\${swagger.enabled}") private val enableSwagger: Boolean ) {
    ...
    fun api(): Docket? {
        return Docket(DocumentationType.SWAGGER_2)
            ...
            .select()
            .apis(RequestHandlerSelectors.basePackage("com.example.webclientimageskotlinsample.controller"))
    ...
    private fun apiInfo(): ApiInfo {
        return ApiInfoBuilder()
            .title("Web Client Images Kotlin Sample Rest Api Documentation")
