...
class SwaggerConfig( @Value("\${swagger.enabled}") private val enableSwagger: Boolean ) {
    ...
    fun api(): Docket? {
        return Docket(DocumentationType.SWAGGER_2)
            ...
            .select()
            .apis(RequestHandlerSelectors.basePackage("com.example.webclientconsumerkotlinsample.controller"))
    ...
    private fun apiInfo(): ApiInfo {
        return ApiInfoBuilder()
            .title("Web Client Consumer Kotlin Sample Rest Api Documentation")
